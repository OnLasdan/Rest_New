...
const aiEndpoints = {
  ...
  '/api/ai/blackbox': createAiEndpoint(
    [
      {
        in: 'query',
        name: 'q',
  ...
  '/api/ai/bingimage': createAiEndpoint(
    [
      {
        in: 'query',
        name: 'q',
  ...
  '/api/ai/Pixart-A': createAiEndpoint(
    [
      {
        in: 'query',
        name: 'prompt',
  ...
  '/api/ai/toanime': createAiEndpoint(
    [
      {
        in: 'query',
        name: 'url',
