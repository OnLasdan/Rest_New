(function (global, factory) {
  ...
  function resetSlideMove (slide) {
    ...
    const windowWidth =
      ...
      document.documentElement.clientWidth ||
      document.body.clientWidth
    let media = hasClass(slide, 'gslide-media')
      ? slide
  ...
  function slideVideo (slide, data, index, callback) {
    ...
    injectAssets(this.settings.plyr.js, 'Plyr', function () {
      ...
      const placeholder = customPlaceholder || createHTML(
        '<div id="'
      ...
      const playerConfig = has(_this.settings.plyr, 'config')
    ...
    _createClass(GlightboxInit, [
      ...
      },
      {
        ...
        value: function build () {
          ...
          const nextSVG = has(this.settings.svg, 'next')
            ? this.settings.svg.next
            : ''
          const prevSVG = has(this.settings.svg, 'prev')
            ? this.settings.svg.prev
            : ''
          const closeSVG = has(this.settings.svg, 'close')
      ...
      },
      {
        ...
        value: function resize () {
          ...
          if (video) {
            let ratio = has(this.settings.plyr.config, 'ratio')
      ...
      },
      {
        key: 'loop',
        value: function loop () {
          let loop = has(this.settings, 'loopAtEnd')
